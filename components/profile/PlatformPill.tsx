...
export function PlatformPill({ platform }: { platform: Platform }) {
  ...
  return (
    <a
      ...
      className="inline-flex items-center gap-1.5 border border-near-black/20 px-2.5 py-1 font-mono text-xs text-olive hover:text-near-black hover:border-near-black transition-colors"
    >
